...
const rndIntiatives = createSlice({
  name: "rndIntiatives",
  initialState,
  reducers: {},
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchEventGrants.fulfilled, (state, action: PayloadAction<RnD[]>) => {
      state.loading = false;
      state.rndInitiativeData = action.payload;
    });
...
export default rndIntiatives.reducer;
