...
const eventGrantSlice = createSlice({
  name: "eventGrant",
  initialState,
  reducers: {},
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchEventGrants.fulfilled, (state, action: PayloadAction<EventGrant[]>) => {
      state.loading = false;
...
export default eventGrantSlice.reducer;
