...
interface MembershipProfessinalBodies {
  id: string;
  title: string;
  department: string;
  amount: number;
...
interface State {
  membershipProfessinalBodiesData : MembershipProfessinalBodies[];
  loading: boolean;
  error: string | null;
}

const initialState: State = {
  membershipProfessinalBodiesData : [],
  loading: false,
  error: null,
};
...
const membershipProfessinalBodies = createSlice({
  name: "membershipProfessinalBodies",
  initialState,
  reducers: {},
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchEventGrants.fulfilled, (state, action: PayloadAction<MembershipProfessinalBodies[]>) => {
      state.loading = false;
      state.membershipProfessinalBodiesData = action.payload;
    });
...
export default membershipProfessinalBodies.reducer;
