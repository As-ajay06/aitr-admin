...
interface State {
  academicQualificationData: AcademicQualification[];
  loading: boolean;
  error: string | null;
}
...
const academicQualification = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchEventGrants.fulfilled, (state, action: PayloadAction<AcademicQualification[]>) => {
      state.loading = false;
      state.academicQualificationData = action.payload;
    });
...
export default academicQualification.reducer;
