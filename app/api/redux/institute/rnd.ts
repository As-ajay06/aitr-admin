...
const isntituteRndSlice = createSlice({
  name: "consultancy",
  initialState,
  reducers: {},
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchEventGrants.fulfilled, (state, action: PayloadAction<InstituteRnd[]>) => {
      state.loading = false;
      state.instituteRndData = action.payload;
    });
...
export default isntituteRndSlice.reducer;
