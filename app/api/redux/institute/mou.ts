...
const instituteMouSlice = createSlice({
  name: "consultancy",
  initialState,
  reducers: {},
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchEventGrants.fulfilled, (state, action: PayloadAction<InstituteMou[]>) => {
      state.loading = false;
      state.instituteMouData = action.payload;
    });
...
export default instituteMouSlice.reducer;
