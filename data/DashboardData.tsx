...
// todo: dashboard data where super user will see all the teachers, student etc.. data in one place
// todo: i can make this link where , user will redirected to the just view form and delete the entry.
